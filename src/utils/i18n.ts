...
export const i18n = {
  de: {
    ...
    'nav.faq': 'FAQ',
    'nav.search': 'Suche',
    'hero.title': 'Deine Arbeitszeit auf den Punkt.',
    ...
    'footer.text': 'Arbeitszeit Rechner — 100 % kostenlos, werbefrei & ohne Anmeldung. Alle Berechnungen lokal in deinem Browser.',
    'footer.links': 'Links',
  ...
  en: {
    ...
    'footer.text': 'Work Time Calculator — 100% free, ad-free & no registration required. All calculations run locally in your browser.',
    'footer.links': 'Links',
  ...
  fr: {
    ...
    'footer.text': 'Calculateur de Temps de Travail — 100% gratuit, sans publicité et sans inscription. Tous les calculs sont effectués localement dans votre navigateur.',
    'footer.links': 'Liens',
  ...
  ar: {
    ...
    'footer.text': 'حاسبة ساعات العمل — مجانية 100%، خالية من الإعلانات ولا تتطلب تسجيل. تتم جميع العمليات الحسابية محلياً في متصفحك.',
